...
class LexRank(object):
    ...
    def summarize(self, text):
        ...
        # Inject tf-idf into the member variable tf-idf of the sentence object
        start_time=time.time()
        print("     <LEXRANK> _inject_tfidfs")
        self._inject_tfidfs()
        print("     %.02f sec" % (time.time() - start_time)+"\n")
        ...
        # Text Rank
        start_time=time.time()
        print("     <LEXRANK> sentences2graph, networkx.pagerank")
        self.graphs = []
